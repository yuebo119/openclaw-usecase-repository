...
4.   Connecting your first messaging channel
...
If the dashboard loads and you can type a message and get a reply
...
```bash
openclaw cron add --name "OpenClaw1012026March29完整指南AI" --schedule "0 */6 * * *" --skill "skill-20260420-007"
```
...
- **案例来源**: Tavily 搜索
- **原文链接**: https://sidsaladi.substack.com/p/openclaw-101-2026-march-29-the-complete
- **生成时间**: 2026-04-20T12:45:36.915Z
